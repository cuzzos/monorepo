...
#if canImport(SharedCoreFFI)
import SharedCoreFFI
#endif
...
public enum CoreError: Swift.Error, Equatable, Hashable, Foundation.LocalizedError {
    ...
    case EventProcessingError(message: String)
...
public struct FfiConverterTypeCoreError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> CoreError {
        ...
        case 3: return .EventProcessingError(
            message: try FfiConverterString.read(from: &buf)
        )
    ...
    public static func write(_ value: CoreError, into buf: inout [UInt8]) {
        ...
        case .EventProcessingError(_ /* message is ignored*/):
...
public func handleResponse(_ id: UInt32, _ res: Data)throws  -> Data  {
...
public func processEvent(_ msg: Data)throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_shared_checksum_func_handle_response() != 25430) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_shared_checksum_func_process_event() != 6825) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_shared_checksum_func_view() != 51737) {
        return InitializationResult.apiChecksumMismatch
    }
